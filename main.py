...
async def gemini_session_handler(client_websocket: websockets.WebSocketServerProtocol):
    try:
        ...
        async with client.aio.live.connect(model=MODEL, config=config) as session:
            ...
            session.audio_data = b''  # Initialize audio buffer
                        ...
                        try:
                            ...
                            async for response in session.receive():
                                ...
                                if model_turn:
                                    for part in model_turn.parts:
                                        if hasattr(part, 'text') and part.text is not None:
                                            ...
                                            #  Accumulate audio zo gemini ne diya hai 
                                ...
                                if response.server_content.turn_complete:
                                    ...
                                    session.audio_data = b''  #  Clear krna hai  after transcription
...
#         # Creating a client specific for transcription (assuming Gemini 1.5 flash)
#         transcription_client = generative.GenerativeModel(model_name=TRANSCRIPTION_MODEL)
